...
<body>
    <div class="navbar">
        ...
        <div>
            <a href="../views/producto_form.php" style="background-color: #2980b9; margin-right: 10px;">Agregar Producto</a>
            ...
            <tbody>
                <?php foreach ($productos as $prod): ?>
                    <tr>
                        ...
                        <td>
                            <a href="../views/producto_form.php?id=<?= $prod['id'] ?>" style="background-color: #f39c12; color: white; padding: 5px 10px; text-decoration: none; border-radius: 4px; font-size: 13px; font-weight: bold;">Editar</a>
                        </td>
                        <td>
                            <form action="../controllers/horneados.php" method="POST" style="margin: 0;">
                                <input type="hidden" name="id" value="<?= $prod['id'] ?>">
                                <button type="submit" class="btn-hornear">Hornear (+<?= $prod['cantidad_por_tanda'] ?>)</button>
                            </form>
                        </td>
                        <td>
                            <form action="../controllers/perdidas.php" method="POST" class="form-inline" style="margin: 0;">
                                <input type="hidden" name="id" value="<?= $prod['id'] ?>">
